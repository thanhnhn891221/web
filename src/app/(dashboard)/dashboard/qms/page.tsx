    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="flex-1 relative">
          ...
          <input type="text" placeholder="Tìm kiếm phiếu kiểm định..." className="w-full pl-10 pr-4 py-2 border rounded-lg bg-[var(--primary-950)] border-[var(--primary-800)] text-white focus:ring-2 focus:ring-[var(--primary-500)] outline-none transition-all placeholder:text-white/40" />
        </div>
