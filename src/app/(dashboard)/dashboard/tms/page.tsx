      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <div className="relative w-full sm:w-64">
            ...
            <input type="text" placeholder="Tìm kiếm dữ liệu..." className="w-full pl-10 pr-4 py-2 border rounded-lg bg-[var(--primary-950)] border-[var(--primary-800)] text-white focus:ring-2 focus:ring-[var(--primary-500)] outline-none transition-all placeholder:text-white/40" />
          </div>
